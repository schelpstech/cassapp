 <?php
    ...
    if ($consultantDetails['workStatus'] == 100) {
        $utility->redirectWithNotification(
            'danger',
            'Error! You are yet to upload job completion details.',
            'uploadJobCompletion'
        );
        exit;
                                 ...
                                 <div class="col-md-8">
                                     <table class="table table-sm table-borderless">
                                         <tr>
                                             ...
                                             <td>
                                                 <h4><?php echo htmlspecialchars($consultantDetails['companyName']); ?></h4>
                                             </td>
                                         </tr>
                                         <tr>
                                             <th>Number of Cleared Schools:</th>
                                             <td>
                                                 <h4><?php echo intval($numclearedSchoolRecords); ?></h4>
                                             </td>
                                         </tr>
                                         <tr>
                                             <th>Total Number of Candidates:</th>
                                             <td>
                                                 <h4><?php echo $totalCand; ?></h4>
                                             </td>
                                         </tr>
                                         <tr>
